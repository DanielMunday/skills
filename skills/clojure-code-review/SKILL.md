---
name: clojure-code-review
description: |
  Clojure code review for Metabase codebases. Use when: reviewing Clojure pull requests,
  checking compliance with the Metabase Clojure style guide, auditing naming conventions,
  documentation, module patterns, REST API conventions, MBQL usage, database models,
  or driver implementations.
---
