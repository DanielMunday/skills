...
name: add-entity
description: |
  Create a domain entity following FSH (FullStackHero) patterns with full multi-tenancy support.
  Use when creating new domain entities with AggregateRoot, IHasTenant, IAuditableEntity,
  ISoftDeletable, EF Core configuration, domain events, and migrations.
---
