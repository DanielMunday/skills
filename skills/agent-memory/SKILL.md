...
name: agent-memory
description: |
  Persistent memory space for storing knowledge that survives across conversations.
  Use when: saving research findings, codebase patterns, solutions to tricky problems,
  architectural decisions, or in-progress work; checking prior findings before
  investigating a problem; or organizing and consolidating accumulated knowledge.
---
