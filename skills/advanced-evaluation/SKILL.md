...
description: |
  ...
  Use when building automated evaluation pipelines, comparing model responses,
  establishing quality standards, designing rubrics, or analyzing correlation
...
│               ▼                                   │
│  ┌─────────────────────────┐                     │
│  │   Primary Scorer        │ ──→ Direct/Pairwise  │
│  └────────────┬────────────┘                     │
│               │                                   │
│               ▼                                   │
│  ┌─────────────────────────┐                     │
│  │   Bias Mitigation       │ ──→ Position swap    │
│  └────────────┬────────────┘                     │
│               │                                   │
│               ▼                                   │
│  ┌─────────────────────────┐                     │
...
**Second Pass (B first)**: `{ "winner": "A", "confidence": 0.6 }` ← A because B was in first position

**Mapped Second Pass**: `{ "winner": "B", "confidence": 0.6 }`
