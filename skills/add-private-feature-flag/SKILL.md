...
description: |
  Add a new private feature flag to Ghost CMS. Private flags appear in Labs settings
  under the "Private features" tab, visible only when developer experiments are enabled.
  Use when adding new Labs flags to ghost/core/core/shared/labs.js and the admin UI.
---
