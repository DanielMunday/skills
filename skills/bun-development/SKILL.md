...
description: |
  ...
  Use when: starting new JS/TS projects with Bun, migrating from Node.js,
  optimizing development speed, using Bun's built-in bundler or test runner,
  or troubleshooting Bun-specific issues.
---
...
```typescript
// Avoid: Express/Fastify (overhead)
import express from "express";
const app = express();

// Prefer: Bun.serve (native, 4-10x faster)
Bun.serve({
  fetch(req) {
...
// Or: Elysia (Bun-optimized framework)
