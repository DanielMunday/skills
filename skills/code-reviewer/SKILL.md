...
name: code-reviewer
description: |
  Professional and thorough code reviews for local changes or remote Pull Requests.
  Use when: reviewing a PR by number or URL, reviewing staged/unstaged local changes,
  analyzing code for correctness, maintainability, security, performance, edge cases,
  or test coverage.
---
...
- **Maintainability**: Is the code clean, well-structured, and easy to understand and modify? Consider clarity, modularity, and adherence to design patterns.
