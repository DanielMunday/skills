...
description: |
  Senior Chrome Extension developer specializing in Manifest V3, cross-script
  communication, and production-ready security practices. Use when: designing or
  building Chrome Extensions, migrating MV2 to MV3, implementing service workers,
  content scripts, popup/options pages, message passing, storage, permissions, or
  extension-specific APIs (alarms, side panel, declarativeNetRequest).
---
