---
name: agents-workbench-layout
description: |
  Guidelines for working on the Agents workbench layout in VS Code sessions.
  Use when: modifying layout code in sessions/browser/workbench.ts, adding or
  removing parts, changing grid structure, updating menus or actions, or any
  work touching the Agents layout spec at src/vs/sessions/LAYOUT.md.
---

# Agents Workbench Layout
