...
name: blender-mcp
description: |
  Control a running Blender instance via socket on TCP port 9876.
  Use when: creating or manipulating 3D scenes, adding mesh objects, applying
  materials, setting up keyframe animations, or rendering images through
  Blender MCP addon over a local TCP connection.
---
